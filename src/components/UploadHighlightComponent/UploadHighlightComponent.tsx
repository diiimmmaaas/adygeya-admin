...
import styles from './UploadHighlightComponent.module.css'
...
const UploadHighlightComponent: React.FC<UploadPhotoComponentPropsType> = ({
  images,
  setPhotosFiles,
  ...
  return (
    <div className={styles.uploadHighlightContainer}>
      {images && (
        <div>
          <h4 className={styles.uploadHighlightText}>Уже имеющиеся фото к данному объекту</h4>
          <div className={styles.uploadedHighlightBlock}>
      ...
      <h4 className={styles.uploadHighlightText}>Фото, которые можно добавить</h4>
      <div className={styles.uploadHighlightBoard}>
        <input
...
export default UploadHighlightComponent
